...
{ 	
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB|RCC_APB2Periph_GPIOD|RCC_APB2Periph_GPIOE|RCC_APB2Periph_GPIOG, ENABLE);	 //使能PB,PD,PE,PG端口时钟

	RCC_AHBPeriphClockCmd(RCC_AHBPeriph_FSMC,ENABLE);

	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0;				 //PB0 推挽输出 复位引脚
	...
	writeTiming.FSMC_DataSetupTime = 0x03;		 ////数据保存时间为5个HCLK	
